package com.htpindan.modules.utils;
...
public class ReflectionsTest {
	...
	public void invokeMethod() {
		...
		assertThat(
				Reflections
						.invokeMethod(bean, "privateMethod", new Class[] { String.class }, new Object[] { "huipeng" }))
				.isEqualTo("hello huipeng");

		// 仅匹配函数名
		assertThat(Reflections.invokeMethodByName(bean, "privateMethod", new Object[] { "huipeng" })).isEqualTo(
				"hello huipeng");

		// 函数名错
		try {
			Reflections.invokeMethod(bean, "notExistMethod", new Class[] { String.class }, new Object[] { "huipeng" });
			failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
		} catch (IllegalArgumentException e) {
		...
		// 参数类型错
		try {
			Reflections.invokeMethod(bean, "privateMethod", new Class[] { Integer.class }, new Object[] { "huipeng" });
		...
		// 函数名错
		try {
			Reflections.invokeMethodByName(bean, "notExistMethod", new Object[] { "huipeng" });
			failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
		} catch (IllegalArgumentException e) {
